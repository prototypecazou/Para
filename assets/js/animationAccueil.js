...
var taillePortfolio = boxPortfolio[0].clientWidth
	...
	window.onresize = function() {
		...
		if(window.location.hash == ""){
			elementResize = document.querySelector("section[data-resize=resize0")
		}
	...
	function scrollWindow(event){ 
		...
		if(page == 6  && event.deltaY < 0 || page == 6  && event < 0){
			temps = 1500
			time = 1000
		}
...
var btnDecouvrirWork = document.querySelector("#work")
...
upLong.onclick = function(){
	...
	btnDecouvrirWork.href="./prestations.html"+"#"+t
	t--
	if(t < 2){
		t = 6
	}
